...
function Signup() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-dark">
      <div className="w-full max-w-md space-y-8 p-8 bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm rounded-xl shadow-2xl border border-white/10">
        <div className="flex flex-col gap-6 items-center justify-center">
          ...
          <div className="flex flex-col gap-1 items-center justify-center">
            ...
            <div className="text-center text-sm text-gray-400">
              Join DropVault for secure file sharing
            </div>
          </div>
        </div>
